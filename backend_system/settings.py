...
# Add these lines to tell Django where your static files are
import os
STATICFILES_DIRS = [
    BASE_DIR / 'static',
]
...
# Use WhiteNoise to serve static files in production (in Docker/Gunicorn)
